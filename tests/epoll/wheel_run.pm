#!/usr/bin/perl -w
# $Id: wheel_run.pm,v 1.2 2004/11/22 00:13:53 rcaputo Exp $
...
use POE qw( Loop::Epoll Wheel::Run Filter::Line Pipe::TwoWay Pipe::OneWay);
ok_if(25, defined($INC{'POE/Loop/Epoll.pm'}) == 1, "loaded Epoll.pm");
