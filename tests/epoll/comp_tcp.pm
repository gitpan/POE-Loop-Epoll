#!/usr/bin/perl -w
# $Id: comp_tcp.pm,v 1.1 2004/09/04 22:50:39 rcaputo Exp $
...
use POE qw( Loop::Epoll  Component::Server::TCP Wheel::ReadWrite Component::Client::TCP );


ok_if(19, defined($INC{'POE/Loop/Epoll.pm'}) == 1);
