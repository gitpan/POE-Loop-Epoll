#!/usr/bin/perl -w
# $Id: wheel_sf_udp.pm,v 1.1 2004/09/04 22:50:39 rcaputo Exp $
...
use POE qw( Loop::Epoll  Wheel::SocketFactory );
...
test_setup(14);
ok_if(14, defined($INC{'POE/Loop/Epoll.pm'}) == 1, "loaded Epoll.pm");
###############################################################################
